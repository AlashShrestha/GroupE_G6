...
<div class="vh-100">
        <div class="content"
            ...
            <div class="col-5" style="box-sizing: border-box;">
                <h1 class="text-light"><b>Sign up to</b><br>Traffix!</h1>
                <p class="text-light">
            ...
            <div class="row d-flex justify-content-center" style="position: relative;top: 175px;">
                <div class="col-12 col-md-7 col-lg-6">
                    <div class="card-body p-7">
                        ...
                        <form action="login3.php" method="post" class="row border border-0 border-dark mx-0 my-0">
                            ...
                            <div class="d-flex justify-content-end align-items-center">
                                <p class="me-2 mb-0">Have account?</p>
                            </div>
                            <div class="d-flex justify-content-end">
                                <a href="login.php" class="text-primary fw-bold ms-2"
                                    style="padding: 5px 11px;">Sign in</a>
							...
							<input type="text" class="form-control input-field" id="floatingInput"
                                ...
                                <label for="floatingInput" style="margin-left: 7px;">User Name</label>
                            ...
                            <div class="form-floating mb-1">
							<input type="email" class="form-control input-field" id="floatingInput"
                                    placeholder="email" name="email" autocomplete="" required>

                                <label for="floatingInput" style="margin-left: 7px;">Email address</label>
